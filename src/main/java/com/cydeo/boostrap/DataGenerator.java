...
public class DataGenerator implements CommandLineRunner { // CommandLineRunner interface we need to use and know.
    ...
    // we created this interface object because to reach interface's methods like save or anything to make loosely coupling.
    ...
    public void run(String... args) throws Exception {
        ...
        // this run method will excute FIRST BEFORE ANYTHING when you start the application.
        // create some roles and put in the DB(map). That's why we have this override method.
